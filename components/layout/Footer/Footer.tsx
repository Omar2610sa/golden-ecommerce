        ...
        <footer className="border-t bg-footer text-white">
            ...
            <div className=" border-t border-white/10">
                <div className="container py-6 text-sm text-white/70 flex justify-between items-center">
                    ...
                    <span>
                        من تطوير ومبرمجة <Link href="https://www.linkedin.com/in/omar-salam-064126257/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Omar Moataz</Link>
                    </span>
                </div>
